...
- **Dependence Modeling Course Materials** – Public repository with R and Python simulations for structure learning in undirected and directed graphical models: [GitHub link](https://github.com/AnasMourahib/Dependence-modeling-).  
- **Penalized Least Squares Estimator for Extreme-Value Mixture Models** – Accompanying paper implementations in R, C, Python, and Julia: [GitHub link](https://github.com/AnasMourahib/Penalized_least-squares_estimator).
